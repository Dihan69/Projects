...
public class MainQuest9 extends Quest{
    ...
    int dialogue1_phase=0, dialogue2_phase=29;

    int hedgehog_killed =0;

    int charIndex=0;
    String combinedString="";
    public MainQuest9(GamePanel gp) {
        super(gp);
    ...
    {
        phase_command[0]="Meet the Wizard";
        phase_command[1]="Kill the Pumpkins [0/28]";
        phase_command[2]="Kill the Pumpkins [1/28]";

        for (int i = 3; i <= 28; i++) {
            phase_command[i] = "Kill the Pumpkins [" + (i - 1) + "/28]";
        }
        phase_command[29]="Talk to the wizard";
        phase_command[30]="[[COMPLETED]]";
    }
