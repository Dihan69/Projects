...
public class MainQuest12 extends Quest{
    ...
    public MainQuest12(GamePanel gp) {
        super(gp);

        name="Order of Teleporter";
    ...
    {
        dialogues1[0]="Wow, it's been a while since anyone got into my house.";
        dialogues1[1]="Did cheif send you from village?";
        dialogues1[2]="Yes, sir. He send us to you help finding key.";
        dialogues1[3]="I trust anyone who can solve my puzzle of teleporter.";
        dialogues1[4]="Take my boat and find the key in one of the islands";
    ...
    {
        phase_command[0]="Find a way to reach the house in desert";
    ...
    public void update()
    {
        ...
        if(gp.gameState==gp.playState) {
            ...
            {
                if(gp.player.BoyWorldX>=11956 && gp.player.BoyWorldX<=12050 && gp.player.BoyWorldY>=940 && gp.player.BoyWorldY<=970)
                    house_close=true;
                else  if(gp.player.GirlWorldX>=11956 && gp.player.GirlWorldX<=12050 && gp.player.GirlWOrldY>=940 && gp.player.GirlWOrldY<=970)
                    house_close=true;
                else
                    house_close=false;
            }
    ...
    public void draw(Graphics2D g2) {
        if (gp.gameState == gp.playState) {
            ...
            if(house_close==true)
            {
                ...
                int screenX= 11970-gp.player.worldX+gp.player.screenX+125;
                int screenY= 600-gp.player.worldY+gp.player.screenY+200;
