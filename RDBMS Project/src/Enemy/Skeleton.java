...
public class Skeleton extends Entity {
    ...
    public Skeleton(GamePanel gp) {
        ...
        speed=1;
        solidArea=new Rectangle(5, 5, 85-5, 45-5);
        ...
        damageSolidArea=new Rectangle(0,0,width,height);
        action="walk";
        direction="left";
        max_health=10;
    ...
    public void getImage()
    {
        try
        {
            for(int i=0; i<4; i++) {
                ...
                walk_up[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/skeleton/up/" + (i + 1) + ".png"));
                walk_right[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/skeleton/right/" + (i + 1) + ".png"));
                walk_left[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/skeleton/left/" + (i + 1) + ".png"));
                walk_down[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/skeleton/down/" + (i + 1) + ".png"));
