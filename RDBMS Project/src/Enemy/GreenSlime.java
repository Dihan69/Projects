    ...
    public void getImage()
    {
        try
        {
            for(int i=0; i<4; i++) {
                ...
                walk_up[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/green-ghost/up/" + (i + 1) + ".png"));
                walk_right[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/green-ghost/right/" + (i + 1) + ".png"));
                walk_left[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/green-ghost/left/" + (i + 1) + ".png"));
                walk_down[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/green-ghost/down/" + (i + 1) + ".png"));
