...
public class RhinoBettle extends Entity {


    public BufferedImage[] idle_up= new BufferedImage[4];
    public BufferedImage [] idle_down= new BufferedImage[4];
    ...
    public RhinoBettle(GamePanel gp) {
        super(gp);
    ...
    public void getImage()
    {
        try
        {
            for(int i=0; i<4; i++) {
                ...
                walk_up[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/rhino-beetle/move/up/" + (i + 1) + ".png"));
                walk_right[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/rhino-beetle/move/right/" + (i + 1) + ".png"));
                walk_left[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/rhino-beetle/move/left/" + (i + 1) + ".png"));
                walk_down[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/rhino-beetle/move/down/" + (i + 1) + ".png"));
            ...
            for(int i=0; i<4; i++) {
                ...
                attack_up[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/rhino-beetle/attack/up/" + (i + 1) + ".png"));
                attack_right[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/rhino-beetle/attack/right/" + (i + 1) + ".png"));
                attack_left[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/rhino-beetle/attack/left/" + (i + 1) + ".png"));
                attack_down[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/rhino-beetle/attack/down/" + (i + 1) + ".png"));

            }

            for(int i=0; i<4; i++)
            {
                idle_up[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/rhino-beetle/idle/up/1.png"));
                idle_right[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/rhino-beetle/idle/right/1.png"));
                idle_left[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/rhino-beetle/idle/left/1.png"));
                idle_down[i] = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/rhino-beetle/idle/down/1.png"));
            }
    ...
    public int detectionX=180;
    public int detectionY=180;
    ...
    public  void target_player_logic()
    {
        ...
        if(eventCounter%10==0)
        {
            ...
            if( action=="walk" && (abs(targetX-worldX)<40) && (abs(targetY-worldY)<40)    )
            {
                action="attack";
            }
